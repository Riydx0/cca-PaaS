      ...
      <div className="hidden lg:flex w-1/2 bg-sidebar text-sidebar-foreground flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div>
          ...
          <div className="max-w-md relative z-10 space-y-8">
            <h1 className="text-4xl font-black text-white leading-tight">Build faster with unified infrastructure.</h1>
            <p className="text-sidebar-foreground/70 text-lg leading-relaxed">Join thousands of IT teams managing multi-cloud deployments efficiently.</p>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-[400px]">
          <div className="mb-6 lg:hidden text-center">
            ...
            <p className="text-muted-foreground mt-1 text-sm">Create a new account</p>
          </div>
